...
},{"../scripts/d3Engine.js":8,"react":205}],2:[function(require,module,exports){
var React = require('react');
...
},{"../scripts/d3PriceEngine":9,"react":205}],3:[function(require,module,exports){
React = require('react');
  ...
  getInitialState: function() {
	...
	render: function() {
      ...
      React.createElement("div", null, 
        ...
        React.createElement("h4", null, "Welcome, ", this.state.username, "!"), 
        React.createElement(TopControlRow, {email: this.props.email}), 
        React.createElement("div", {className: "row"}, 
          React.createElement(YouAreFollowingBox, null), 
          React.createElement(FollowingYouBox, null)
        )
      )
		);
	}
...
var TopControlRow = React.createClass({displayName: "TopControlRow",
  render: function() {
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement(ChangePasswordBox, null), 
        React.createElement(EditContactInfoBox, {email: this.props.email})
      )
    );
  }
});

var ChangePasswordBox = React.createClass({displayName: "ChangePasswordBox",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "dashboard-option"}, 
        React.createElement("p", null, React.createElement("a", {href: "#", onClick: this.handleClick}, "Change password")), 
        React.createElement("input", {type: "password", placeholder: "old password", className: "form-control password-change-field hidden", ref: "oldPassword1"}), 
        React.createElement("input", {type: "password", placeholder: "new password", className: "form-control password-change-field hidden", ref: "newPassword"}), 
        React.createElement("input", {type: "password", placeholder: "confirm new password", className: "form-control password-change-field hidden", ref: "newPassword2"})
      )
    );
  }
});

var EditContactInfoBox = React.createClass({displayName: "EditContactInfoBox",
  handleClick: function(e) {
    e.preventDefault();
  ...
  render: function() {
    return (
      React.createElement("div", {className: "dashboard-option"}, 
        React.createElement("p", null, React.createElement("a", {href: "#", onClick: this.handleClick}, "Edit contact info")), 
        React.createElement("div", {className: "contact-change hidden"}, "Email: ", this.props.email), 
        React.createElement("input", {type: "text", placeholder: "new email", className: "form-control contact-change hidden", ref: "newEmail"})
      )
    );
  }
});

var YouAreFollowingBox = React.createClass({displayName: "YouAreFollowingBox",
  handleClick: function(e) {
    e.preventDefault();
  ...
  render: function() {
    return (
      React.createElement("div", {className: "dashboard-option"}, 
        React.createElement("p", null, React.createElement("a", {href: "#", onClick: this.handleClick}, "Users You Are Following")), 
        React.createElement(FavoriteUsersDisplay, {user: "user1"}), 
        React.createElement(FavoriteUsersDisplay, {user: "user2"})
      )
    );
  }
});

var FollowingYouBox = React.createClass({displayName: "FollowingYouBox",
  handleClick: function(e) {
    e.preventDefault();
  ...
  render: function() {
    return (
      React.createElement("div", {className: "dashboard-option"}, 
        React.createElement("p", null, React.createElement("a", {href: "#", onClick: this.handleClick}, "Users Following You")), 
        React.createElement(FollowersDisplay, {user: "user1"}), 
        React.createElement(FollowersDisplay, {user: "user2"})
      )
    );
  }
});

var FavoriteUsersDisplay = React.createClass({displayName: "FavoriteUsersDisplay",
  ...
  render: function() {
    return (
        React.createElement("div", {className: "user-following hidden"}, 
          this.props.user, 
          React.createElement("a", {className: "unfollow", "data-user": this.props.user, onClick: this.handleUnfollow, href: "#"}, "unfollow")
        )
    );
  }
});

var FollowersDisplay = React.createClass({displayName: "FollowersDisplay",
  handleUnfollow: function(e) {
    e.preventDefault();
    console.log('requested to unfollow ' + this.props.user);
  },
  ...
  render: function() {
    return (
        React.createElement("div", {className: "following-you hidden"}, 
          this.props.user, 
          React.createElement("a", {className: "follow", "data-user": this.props.user, onClick: this.handleFollow, href: "#"}, "follow"), 
          React.createElement("a", {className: "unfollow", "data-user": this.props.user, onClick: this.handleUnfollow, href: "#"}, "unfollow")
        )
    );
  }
  ...
  render: function() {
    return (
      React.createElement("div", {className: "individual-review-display"}, 
        ...
        React.createElement("div", null, 
          React.createElement("strong", null, "Review:"), " ", this.props.reviewText
        ), 
        React.createElement("div", null, 
          React.createElement("span", {className: "upvotes"}, "+", this.props.upVotes), " | ", React.createElement("span", {className: "downvotes"}, "-", this.props.downVotes)
        )
      )
    );
  }
...
var DisplayBox = React.createClass({displayName: "DisplayBox",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "displayBox"}, 
        ...
        React.createElement(D3PriceChart, {
        ...
        React.createElement("div", {className: "related-results-display-container"}, 
          ...
          React.createElement(WalmartRelatedResultsDisplay, {
            ...
            onReviewRequest: this.handleReviewRequest}), 
          React.createElement(BestbuyRelatedResultsDisplay, {
...
var SearchForm = React.createClass({displayName: "SearchForm",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "query-form-container"}, 
        React.createElement("h4", {className: "query-form-title"}, "ShopChimp, at your service."), 
      ...
      React.createElement("nav", {className: "navbar navbar-inverse navbar-fixed-top"}, 
        React.createElement("div", {className: "container-fluid"}, 
          React.createElement("div", {className: "navbar-header"}, 
            ...
            React.createElement(Router.Link, {to: "home", className: "navbar-brand home"}, "ShopChimp")
          ), 
          ...
          React.createElement("div", {className: "collapse navbar-collapse", id: "bs-example-navbar-collapse-1"}, 
            React.createElement("ul", {className: "nav navbar-nav navbar-right"}, 
              ...
              React.createElement("li", {className: "dashboard"}, 
                React.createElement(Router.Link, {to: "dashboard"}, "Dashboard")
              )
            )
          )
        )
...
var LogoArea = React.createClass({displayName: "LogoArea",
  render: function() {
    return (
      React.createElement("div", {className: "logo-container"}, 
        React.createElement("h1", {className: "logo-title"}, React.createElement("img", {src: "images/chimp.png", className: "logo-image"}), "ShopChimp"), 
        React.createElement("h3", {className: "logo-tagline"}, "A Data Visualization Tool for Shoppers")
      )
    );
  }
});
...
var routes = (
  React.createElement(Router.Route, {name: "app", path: "/", handler: App}, 
    ...
    React.createElement(Router.Route, {name: "dashboard", path: "/dashboard", handler: routes.Dashboard}), 
...
},{"../routes/Dashboard":3,"../routes/Home":7,"react":205,"react-router":41}],11:[function(require,module,exports){
...
},{"react/lib/ExecutionEnvironment":70,"react/lib/invariant":185}],19:[function(require,module,exports){
'use strict';
...
},{"object-assign":50,"qs":12,"react/lib/invariant":185}],22:[function(require,module,exports){
'use strict';
...
},{"./PathUtils":21,"react/lib/Object.assign":76,"react/lib/invariant":185,"react/lib/warning":204}],25:[function(require,module,exports){
'use strict';
...
},{"./getWindowScrollPosition":40,"react/lib/ExecutionEnvironment":70,"react/lib/invariant":185}],26:[function(require,module,exports){
'use strict';
...
module.exports = Route;
},{"../PropTypes":22,"./RouteHandler":37,"react":205,"react/lib/invariant":185}],37:[function(require,module,exports){
'use strict';
...
},{"./Route":24,"./components/DefaultRoute":32,"./components/NotFoundRoute":34,"./components/Redirect":35,"react":205,"react/lib/Object.assign":76,"react/lib/warning":204}],40:[function(require,module,exports){
'use strict';
...
},{"react/lib/ExecutionEnvironment":70,"react/lib/invariant":185}],41:[function(require,module,exports){
'use strict';
...
},{"react/lib/invariant":185}],47:[function(require,module,exports){
'use strict';
...
},{"../History":18,"../actions/LocationActions":28,"react/lib/invariant":185}],48:[function(require,module,exports){
'use strict';
